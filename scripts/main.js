...
const channels = [
  ...
  { number: 7, name: "channel 7 – headspace", embedUrl: "headspace/index.html", description: "a game of search and discovery; finding all your emotions once again after a period of mental struggle and numbness; becoming a whole person again- finding yourself. inspired by omori, life is strange, stardew valley, oxenfree." },
...
// const TYPE_DURATION = 1500; 
// // const TYPE_DURATION_FAST = 600; 

// let audioUnlocked = false;

// function unlockAudio() {
//   if (audioUnlocked || !typeSound) return;
...
//   typeSoundTimeout = setTimeout(stopTypingSound, TYPE_DURATION_FAST);
// }
...
//   // bottomTextEl.textContent = "use the arrow buttons to switch between channels.";
